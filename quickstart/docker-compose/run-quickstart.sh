...
echo
echoBold "sheeple People Directory:"
echo "sheeple People Directory is the core."
echo "Has a database, and the core system."

# service_controlled_start 'sheeple-sql' $TIME_TO_START 'database system is ready to accept connections'
# service_controlled_start 'sheeple-app' $TIME_TO_START 'Now listening on\:'

service_start 'sheeple-sql' $TIME_TO_START 'database system is ready to accept connections'
# service_start 'sheeple-app' $TIME_TO_START 'Now listening on\:'

# echo
# echoBold "Testing sheeple API:"
...
echo
echoBold "Forcing a build of the sheeple Service:"
docker-compose build sheeple-app

echo
echoBold "Starting the sheeple Service:"
docker-compose up -d sheeple-app
