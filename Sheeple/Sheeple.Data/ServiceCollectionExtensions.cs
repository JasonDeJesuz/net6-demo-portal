...
namespace sheeple.Data
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static void ConfigureIdentity(this IServiceCollection services)
        {
            ...
            .AddEntityFrameworkStores<sheepleContext>()
        ...
        public static IServiceCollection RegisterDataServices(this IServiceCollection services, IConfiguration configuration, string? connectionString = null)
        {
            ...
            // services.AddDbContext<sheepleContext>(o => o.UseInMemoryDatabase("sheeple"));

            // Using SQL Server
            services.AddDbContext<sheepleContext>(o =>
                  o.UseSqlServer(configuration.GetConnectionString("sheepleContext")));

            services.AddTransient<IsheepleContextService, sheepleContextService>();
        ...
        public static void EnsureDatabaseCreated(this IApplicationBuilder app)
        {
            ...
            var dbContext = services.ServiceProvider.GetService<sheepleContext>();
