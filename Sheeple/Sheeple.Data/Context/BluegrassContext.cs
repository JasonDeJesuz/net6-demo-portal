...
namespace sheeple.Data.Context
{
    public class sheepleContext : IdentityDbContext<ApplicationUser>
    {
        #region Members
        ...
        public sheepleContext(DbContextOptions<sheepleContext> options) : base(options)
        {
